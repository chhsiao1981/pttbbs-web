//https://github.com/ptt/pttbbs/blob/master/include/pttstruct.h#L13
export const MAX_IDLEN = 12;
export const MIN_IDLEN = 2;
...
export const NBRD_FAV = 1;
export const NBRD_BOARD = 2;
export const NBRD_LINE = 4;
export const NBRD_FOLDER = 8;
